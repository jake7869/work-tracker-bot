...
class WorkPanel(discord.ui.View):
    ...
    async def upgrade_car(self, interaction, button):
    ...
    async def upgrade_bike(self, interaction, button):
    ...
    async def car_full_upgrade(self, interaction, button):
    ...
    async def reset_leaderboard(self, interaction, button):
        if not interaction.user.guild_permissions.administrator:

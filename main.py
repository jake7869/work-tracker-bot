...
class WorkPanel(discord.ui.View):
    ...
    # Removed Install Part button, style=discord.ButtonStyle.secondary, custom_id="bike_part")
    # Removed function install_part(self, interaction: discord.Interaction, button: discord.ui.Button):
        await self.handle_action(interaction, "bike")
